...
keysP = [ ("M-l",                     spawn "xsecurelock")
        ...
        , ("M-S-[",                   spawn "sudo light -U 3")
        , ("M-S-]",                   spawn "sudo light -A 3")
        , ("M-C-[",                   spawn "sudo light -S 1")
        , ("M-C-]",                   spawn "sudo light -S 100")
        , ("<XF86AudioMute>",         spawn "pulsemixer --toggle-mute")
        , ("<XF86AudioLowerVolume>",  spawn "pulsemixer --change-volume -1")
        , ("<XF86AudioRaiseVolume>",  spawn "pulsemixer --change-volume +1")
        , ("M-[",                     spawn "pulsemixer --change-volume -1")
        , ("M-]",                     spawn "pulsemixer --change-volume +1")
        , ("M-\\",                    spawn "pulsemixer --toggle-mute")
        , ("M-d",                     notifySend 3000 "date && TZ='Europe/Paris' date && TZ='Europe/Moscow' date")
        , ("M-p",                     spawn "rofi -show run")
        , ("M-o",                     spawn "rofi-bluetooth")
        , ("M-s",                     spawn "kitty")
